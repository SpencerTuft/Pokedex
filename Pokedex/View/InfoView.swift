...
class InfoView: UIView {
    ...
    // Setup all the properties that will be displayed in the pokemon quick info view
    var pokemon: Pokemon? {
        didSet {
    ...
    // Adds the styles and formatting for displaying pretty key-value pairs for the pokemons' attributes
    func configureLabel(label: UILabel, title: String, details: String) {
        let attributedText = NSMutableAttributedString(attributedString: NSAttributedString(string: "\(title):  ", attributes: [NSAttributedString.Key.font: UIFont.boldSystemFont(ofSize: 16), NSAttributedString.Key.foregroundColor: UIColor.primary()]))
